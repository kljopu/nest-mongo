...
//ORM TO SCHEMA
export type WhereCondition<SchemaEntity> =
  | FilterQuery<SchemaEntity>[]
  | FilterQuery<SchemaEntity>
  | ObjectLiteral
  | string;
...
> implements RepositoryPort<Entity, EntityProps> {
  protected constructor(
    protected readonly repository: Repository<SchemaEntity>,
    // TODO
    protected readonly mapper: OrmMapper<Entity, SchemaEntity>,
